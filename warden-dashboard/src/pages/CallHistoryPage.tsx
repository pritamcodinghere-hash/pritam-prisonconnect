  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <Card><div className="p-5 flex items-center gap-4"><div className="w-12 h-12 rounded-xl bg-primary-600/10 flex items-center justify-center text-primary-600"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z" /></svg></div><div><p className="text-3xl font-extrabold tracking-tight text-neutral-900 leading-none">{calls.length}</p><p className="text-sm font-semibold text-neutral-700 mt-1">Total Calls</p><p className="text-xs font-medium text-primary-600 mt-1">{filtered.length} filtered</p></div></div></Card>
        <Card><div className="p-5 flex items-center gap-4"><div className="w-12 h-12 rounded-xl bg-success/10 flex items-center justify-center text-success"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div><div><p className="text-3xl font-extrabold tracking-tight text-neutral-900 leading-none">{calls.filter(c=>c.status==='completed').length}</p><p className="text-sm font-semibold text-neutral-700 mt-1">Completed</p><p className="text-xs font-medium text-success mt-1">success</p></div></div></Card>
        <Card><div className="p-5 flex items-center gap-4"><div className="w-12 h-12 rounded-xl bg-error/10 flex items-center justify-center text-error"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div><div><p className="text-3xl font-extrabold tracking-tight text-neutral-900 leading-none">{calls.filter(c=>c.status==='failed').length}</p><p className="text-sm font-semibold text-neutral-700 mt-1">Failed</p><p className="text-xs font-medium text-error mt-1">needs review</p></div></div></Card>
        <Card><div className="p-5 flex items-center gap-4"><div className="w-12 h-12 rounded-xl bg-amber-500/10 flex items-center justify-center text-amber-600"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div><div><p className="text-3xl font-extrabold tracking-tight text-neutral-900 leading-none">{avgDuration}<span className="text-lg font-bold">m</span></p><p className="text-sm font-semibold text-neutral-700 mt-1">Avg Duration</p><p className="text-xs font-medium text-neutral-500 mt-1">{Math.max(...calls.map(c=>c.durationMinutes),0)}m max</p></div></div></Card>
        <Card><div className="p-5 flex items-center gap-4"><div className="w-12 h-12 rounded-xl bg-purple-600/10 flex items-center justify-center text-purple-600"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg></div><div><p className="text-3xl font-extrabold tracking-tight text-neutral-900 leading-none">{withRec}</p><p className="text-sm font-semibold text-neutral-700 mt-1">With Recording</p><p className="text-xs font-medium text-neutral-500 mt-1">{calls.length-withRec} without</p></div></div></Card>
      </div>
