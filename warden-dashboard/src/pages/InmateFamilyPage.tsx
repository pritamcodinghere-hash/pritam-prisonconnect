...
export function InmateFamilyPage() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-3xl font-bold">Prisoner & Family</h1><p className="text-neutral-600">Separate blocks - All Prisoners and their Family</p></div>

      {/* Block 1 - All Prisoners */}
      <Card>
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold flex items-center gap-2"><span className="w-8 h-8 rounded-lg bg-primary-600/10 flex items-center justify-center">👤</span> All Prisoners ({inmates.length})</h2>
      ...
      <Card>
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold flex items-center gap-2"><span className="w-8 h-8 rounded-lg bg-success/10 flex items-center justify-center">👨‍👩‍👧</span> Family Members ({contacts.length})</h2>
